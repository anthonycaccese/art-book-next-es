...
| Game Metadata Style | Sets the style of metadata for 4:3 aspect ratio screens to either "History" (release date and rating), "Stats" (play count and game time) or "History/Stars" (release date and game time). | `Default`, `History`, `Stats`, `History/Stats` |
